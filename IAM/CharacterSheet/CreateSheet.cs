...
namespace CharacterSheetNamespace
{
    public class CreateSheet
    {
        ...
        /// <returns>True if Powers exist</returns>
       // public bool GetSheets(XDocument document, Grid CharacterSheet_grd)
        public void GetSheets(XDocument document, Grid CharacterSheet_grd)
        {
            bool CharacterNeedPowers = false;
            ...
            if (Globals.TemporaryData.SelectedCharacterStats.ToString() != "")
                InsertStats(CharacterSheet_grd);

          //  return CharacterNeedPowers;
        }
