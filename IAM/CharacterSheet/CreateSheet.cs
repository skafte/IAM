...
namespace IAM.CharacterSheet
{
   public class CreateSheet
   {
      ...
      #region Private _____________________________________________________________________________
      #region Layout helper functions _________________________________________________________________
      /// <summary>
      ...
      #region Layout __________________________________________________________________________________
      /// <summary>
            ...
            if (objgrd != null)
            {
               ...
               if (ePage.Element("powers") != null)
               {
                  ...
                  foreach (XElement eValue in Globals.TemporaryData.SelectedCharacterPowers.Descendants(ePage.Element("menuTitle").Value.ToString()))
                  {
                     ...
                     if (expndr != null)
                        clLoadPowers.InsertPowerInformationController(expndr, eValue, ePage.Element("menuTitle").Value.ToString());
                  }
               }
            }
         }
