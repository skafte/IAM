...
namespace IAM.Powers
{
   public class CreatePowerElement
   {
      ...
      #region Create body sections ____________________________________________________________________
      #region Intro _______________________________________________________________________________________
      ...
      private void CreatePowerBody_VersionOf(WrapPanel Intro_wrppnl)
      {
         ...
         VersionOfPre_btn.Style = (Application.Current.Resources["Custom_ButtonStyle_UpArrow"] as Style);
         VersionOfNext_btn.Style = (Application.Current.Resources["Custom_ButtonStyle_DownArrow"] as Style);
      ...
      #endregion __________________________________________________________________________________________

      #region CostDurationType ____________________________________________________________________________
      ...
      #region the rest ____________________________________________________________________________________
      ...
      private void CreatePowerBody_Description(StackPanel stckpnl)
      {
         ...
         DescriptionText_txtbx.Style = (Application.Current.Resources["Custom_TextBoxStyle"] as Style);
      ...
      private void CreatePowerBody_Submodule(StackPanel stckpnl)
      {
         ...
         SubmoduleText_txtbx.Style = (Application.Current.Resources["Custom_TextBoxStyle"] as Style);
      ...
      private void CreatePowerBody_Mirror(StackPanel stckpnl)
      {
         ...
         MirrorText_txtbx.Style = (Application.Current.Resources["Custom_TextBoxStyle"] as Style);
      ...
      private void CreatePowerBody_Errata(StackPanel stckpnl)
      {
         ...
         ErrataText_txtbx.Style = (Application.Current.Resources["Custom_TextBoxStyle"] as Style);
      ...
      private void CreatePowerBody_Comment(StackPanel stckpnl)
      {
         ...
         CommentText_txtbx.Style = (Application.Current.Resources["Custom_TextBoxStyle"] as Style);
