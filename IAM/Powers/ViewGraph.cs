...
namespace IAM.Powers
{
   public class ViewGraph: BaseViewModel
   {
      ...
      #region Event Signatures ____________________________________________________________________
      /// <summary>
      ...
      #region Graph text file creation ________________________________________________________________
